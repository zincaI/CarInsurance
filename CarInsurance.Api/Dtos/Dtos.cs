...
public record ClaimValidityResponse(long CarId, string ClaimDate, string Description, decimal Amount);
public record TimelineEventDto(string Type, DateOnly Date, string Description);